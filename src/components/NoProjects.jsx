...
export default function NoProjects({ addProject }) {
  ...
  return (
    <div className="w-2/3 mt-32 flex flex-col justify-start items-center gap-4 ">
      ...
      <button
        className="mb-4 mt-4 bg-stone-700 text-stone-400 px-3 py-2 rounded-md text-lg hover:bg-stone-600 hover:text-stone-100"
        onClick={addProject}
      >
        Create new project
      </button>
